...
async getName(jid, withoutContact = false) {
                ...
                id = message.client.decodeJid(jid)

                withoutContact = message.client.withoutContact || withoutContact
                ...
                if (id.endsWith("@g.us")) return new Promise(async(resolve) => {
                    ...
                    if (!(v.name.notify || v.subject)) v = message.client.groupMetadata(id) || {}
                    ...
                    } : id === message.client.decodeJid(message.client.user.id) ?

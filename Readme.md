...
Copyright  2023 X-Electra

Permission to use, copy, modify, and distribute this software and its documentation is not granted.
Any use, copying, modification, or distribution requires explicit permission from the copyright holder.
Failing to do so will result in the copyright violation and may result in a loss of copyright ownership
rights and taking down the account or other legal actions
```
